import { useFindPostByIdQuery, useFindPostQuery, useGetPostLikesQuery, useGetRepostsQuery, useIsBookmarkedQuery, useIsPostLikedByMeQuery, useIsRepostedByUserQuery, usePostCommentsQuery } from "../generated/graphql";
